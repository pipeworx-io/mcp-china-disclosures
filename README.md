...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/hkex_licensing_deals \
  -H 'Content-Type: application/json' \
  -d '{}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/hkex_licensing_deals`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
